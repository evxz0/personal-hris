...
function renderBalasanCutiHtml(data: SuratBalasanCutiData): string {
  return `
    <div style="font-family: Arial, sans-serif; font-size: 9.5pt; line-height: 1.35;">
      ...
      <table style="width: 100%; border-collapse: collapse; margin-bottom: 14px; line-height: 1.25;">
        <tr><td style="width: 22px; vertical-align: top; padding-bottom: 3px;">1.</td><td style="text-align: justify; vertical-align: top; padding-bottom: 3px;">Pelaksanaan cuti tahunan Saudara tahun ${data.tahunCuti} dapat dilaksanakan selama <b>${String(data.cuti.jumlahHari || '5').padStart(2, '0')} (${data.cuti.jumlahHariTerbilang})</b> hari kerja terhitung sejak tanggal <b>${data.cuti.tanggalMulai} s/d ${data.cuti.tanggalSelesai}</b> dan aktif kembali bekerja pada tanggal <b>${data.cuti.tanggalAktif}</b></td></tr>
        <tr><td style="width: 22px; vertical-align: top; padding-bottom: 3px;">2.</td><td style="text-align: justify; vertical-align: top; padding-bottom: 3px;">Dengan dilaksanakan cuti tersebut diatas, maka sisa cuti tahunan Saudara untuk tahun ${data.tahunCuti} adalah <b>${data.cuti.sisaCuti} (${data.cuti.sisaCutiTerbilang})</b> hari kerja.</td></tr>
        <tr><td style="width: 22px; vertical-align: top; padding-bottom: 3px;">3.</td><td style="text-align: justify; vertical-align: top; padding-bottom: 3px;">Ongkos Perjalanan Cuti Tahunan (OPCT) ${data.tahunCuti} Saudara <u><b>${data.cuti.statusOpct || 'dapat'}</b></u> dibayarkan. Pengajuan pencairan OPCT tahun ${data.tahunCuti} dapat saudara ajukan melalui aplikasi DigiHc.</td></tr>
        <tr><td style="width: 22px; vertical-align: top; padding-bottom: 3px;">4.</td><td style="text-align: justify; vertical-align: top; padding-bottom: 3px;">Sebelum pelaksanaan cuti tersebut, harap Saudara mengisi form rencana ketidakhadiran pada aplikasi DigiHc.</td></tr>
        <tr><td style="width: 22px; vertical-align: top; padding-bottom: 3px;">5.</td><td style="text-align: justify; vertical-align: top; padding-bottom: 3px;">Jika diperlukan Saudara bersedia kami panggil dan Sisa Cuti Saudara akan kami perhitungkan kembali.</td></tr>
        <tr><td style="width: 22px; vertical-align: top; padding-bottom: 3px;">6.</td><td style="text-align: justify; vertical-align: top; padding-bottom: 3px;">Untuk selanjutnya selamat melaksanakan Cuti, semoga dapat dimanfaatkan sebaik-baiknya dengan harapan sekembalinya dari Cuti, Saudara akan bekerja lebih baik lagi.</td></tr>
      </table>
