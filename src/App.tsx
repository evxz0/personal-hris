...
function AppRoutes() {
  ...
  return (
    <Routes>
      ...
      <Route path="/dashboard" element={isOric ? <Navigate replace to="/surat/ba-cash-opname" /> : <ProtectedRoute><Dashboard /></ProtectedRoute>} />
      ...
      <Route path="/riwayat" element={isOric ? <Navigate replace to="/surat/ba-cash-opname" /> : <Navigate replace to="/riwayat/karyawan" />} />
